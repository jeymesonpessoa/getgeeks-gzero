...
*Variables*
&{inv_pass}         email=kate@hotmail.com      password=abcd123
&{inv_email}        email=kate.com.br           password=abcd123
&{email_404}        email=kate@404.com          password=abcd123
&{empty_email}      email=${EMPTY}              password=abcd123
&{wo_email}         password=abcd123
